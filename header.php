...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Heebo|Hind:300|Josefin+Sans|Muli|Open+Sans|Questrial|Montserrat|Roboto:300" rel="stylesheet">
    <?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
...
<header id="header" role="banner" class="container">
	...
	<nav class="navbar navbar-default pull-right" role="navigation">
        ...
        <a class="portal" href="#" target="_blank">Client Portal</a>
